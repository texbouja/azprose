...
Cette page vous fait faire le tour d'AZprose en cinq minutes. À la fin, vous saurez ouvrir un projet, créer une note, l'enregistrer et passer de l'écriture à l'aperçu.
...
2. Donnez-lui un nom parlant : c'est ce nom qui servira à le relier aux autres notes (voir [[wikilinks]]).
...
> Ce chapitre couvre l'essentiel de la syntaxe : titres, gras, italique, listes, notes de bas de page. Le guide détaille ensuite ce qui fait la force d'AZprose : les liens [[wikilinks]], les encadrés [[callouts]] et les étiquettes [[tags]].
...
2. **Journal** (icône calendrier) — vos notes quotidiennes, classées par mois (voir [[journal]]).
3. **Liens** (icône lien) — le sommaire de la note, ses liens entrants (*backlinks*) et les tags du coffre (voir [[backlinks]]).
...
- Lire la page suivante : [[wikilinks]] — relier vos notes entre elles.
- Consulter l'aide-mémoire : [[raccourcis]].
