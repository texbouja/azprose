...
### Application hôte 
De base le conteneur doit : 
- être orienté projets (comme les Vaults d'Obsidian), pour chaque projet une nouvelle fenêtre et des onglets pour les fichiers d'un même projet; 
...
### Base adoptée
L'application [Marka.md](https://github.com/mattenarle10/markamd) a été adoptée comme base du projet (fork). Architecture Tauri/React. Elle fournit la sidebar, le gestionnaire de fichier et le chrome d'interface. Inconvénient : React. 
On procède donc à une migration de l'UI est de la gestion FS vers Tauri/Svelte. 
