...
### Base adoptée
L'application https://github.com/mattenarle10/markamd a été adoptée comme base du projet (fork). Architecture Tauri/React. Elle fournit la sidebar, le gestionnaire de fichier et le chrome d'interface. Inconvénient assumé : React.
