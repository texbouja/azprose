...
### Framework/Stack
Tauri avec du TypeScript vanilla ou possiblement Vite/React.
### Application hôte 
...
### Fork possible 
l'application https://github.com/mattenarle10/markamd peut être adoptée comme base pour le projet. Architecture Tauri/React. Elle contient déjà une sidebar est un gestionnaire de fichier qui semble solide. 
...
### Base logicielle 
le projet Nodejs  @prosemark semble tout indiqué. Il implémente une approche WYSIWYM et il est formé de plusieurs composants, tous à retenir car tous essentiels dans une édition riche. En particulier @prosemark/latex (intégration Mathjax).  
...
### Piste logicielle 
Une adaption du plugin Obsidian/PDF++ (https://github.com/RyotaUshio/obsidian-pdf-plus) est-elle possible ? En tout cas, sa capacité de linker dans du Markdown une sélection dans un PDF serait un must. 
